      ...
      <header id="header">
        <div className="d-flex flex-column">
          ...
          <nav id="navbar" className="nav-menu navbar">
            <ul>
              <li className="bx bx-home">
                <Button variant="link" onClick={() => scrollToAnchor('hero')}>
                  <span>Home</span></Button></li>
              <br></br>
              <li className="bx bx-notepad">
                <Button variant="link" onClick={() => scrollToAnchor('resume')}>
                  <span>Resume</span></Button></li>
              <br></br>
              <li className="bx bx-message-dots">
                <Button variant="link" onClick={() => scrollToAnchor('contact')}
                ><span>Contact</span></Button></li>
            </ul>
          </nav>
        </div>
      </header>
                ...
                <div className="col-lg-6">
                  <ul>
                    <li><i className="bi bi-chevron-right"></i>
                      <strong>Age:</strong> <span>23</span></li>
                    <li><i className="bi bi-chevron-right"></i>
                      <strong>Phone:</strong> <span>0975341915</span></li>
                    <li><i className="bi bi-chevron-right"></i>
                      <strong>City:</strong> <span>台灣</span></li>
                  </ul>
                </div>
                <div className="col-lg-6">
                  <ul>
                    <li><i className="bi bi-chevron-right"></i>
                      <strong>Degree:</strong> <span>碩士</span></li>
                    <li><i className="bi bi-chevron-right"></i>
                      <strong>PhEmailone:</strong>
                      <span>t1616joey1@gmail.com</span></li>
                    <li><i className="bi bi-chevron-right"></i>
          ...
          <div className="row">
            <div className="col-lg-6" data-aos="fade-up">
              ...
              <div className="resume-item">
                ...
                <p><em>Techs : Git · Sklearn ·
                  Pytorch · Github Action · Docker</em></p>
              ...
              <div className="resume-item">
                ...
                <p><em>Techs : Git · Django ·
                  IOT · HTML · CSS · Javascript</em></p>
            ...
            <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="resume-item">
                ...
                <p><em>Techs : Mariadb · PHP ·
                  Apache · Dojo.js · HTML · CSS </em></p>
                <ul>
                  <li>管理圖書館內部網站</li>
              ...
              <div className="resume-item">
                ...
                <p><em>Techs : Git · Python · CI/CD · Django ·
                  Azure · SQL · cPanel · JavaScript · HTML · CSS</em></p>
                <ul>
                  <li>從0建置新創公司頁面</li>
