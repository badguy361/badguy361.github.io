...
function IconBxlFacebookCircle(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
function IconBxlGithub(props) {
  return (
    <svg
      ...
      {...props}
    >
    <div><i class="bx bxl-facebook">666</i></div>
      <path
        fillRule="evenodd"
...
function IconBxlLinkedinSquare(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export {IconBxlFacebookCircle, IconBxlGithub, IconBxlLinkedinSquare};
